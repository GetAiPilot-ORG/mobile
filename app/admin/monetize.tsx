...
export default function AdminMonetizeScreen() {
  ...
  const [activeTab, setActiveTab] = useState<"links" | "design" | "earnings">(
    "earnings",
  );
  ...
  const [storeBio, setStoreBio] = useState(
    "Exclusive workflows, custom bots, and premium enterprise tooling.",
  );
  ...
  const totalGross = products.reduce(
    (acc, p) => acc + p.price * p.salesCount,
    0,
  );
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Manage digital products, store bio links, and real-time revenue
            analytics.
          </Text>
        </View>
        ...
        <View style={styles.tabsContainer}>
          ...
          <Pressable
            style={[
              styles.tabButton,
              activeTab === "links" && styles.tabButtonActive,
            ]}
          ...
          <Pressable
            style={[
              styles.tabButton,
              activeTab === "design" && styles.tabButtonActive,
            ]}
          ...
          <View>
            ...
            <View style={styles.gatewayCard}>
              <View style={{ flex: 1, paddingRight: 12 }}>
                <View style={styles.gatewayTitleRow}>
                  ...
                  <StatusBadge
                    status={paymentsConnected ? "active" : "inactive"}
                  />
                </View>
            ...
            <View style={styles.metricsGrid}>
              ...
              <View style={[styles.metricCard, { width: "100%" }]}>
                ...
                <Text style={styles.metricSub}>
                  Next automatic settlement on 15th
                </Text>
              </View>
            </View>
        ...
        {activeTab === "design" && (
          <View style={styles.card}>
            ...
            <Text style={styles.cardDesc}>
              Configure the storefront banner, bio headline, and brand elements
              for public buyers.
            </Text>
            ...
            <View style={styles.switchRow}>
              <View style={{ flex: 1, paddingRight: 12 }}>
                <Text style={styles.rowTitle}>
                  Display GetAIPilot Verified Badge
                </Text>
                <Text style={styles.rowSubtitle}>
                  Show official brand authentication seal on checkout
                </Text>
              </View>
              <Switch
                value={showBranding}
            ...
            <Pressable
              ...
              onPress={() =>
                Alert.alert(
                  "Saved",
                  "Storefront styling and branding preferences updated.",
                )
              }
            >
